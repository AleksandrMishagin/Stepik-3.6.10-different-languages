...
class BasePage ():
    ...
    # Проверяем, что после регистрации присутствует иконка пользователя
    def should_be_authorized_user(self):
        assert self.is_element_present(*RegistrationBaseLocators.USER_ICON), "User icon is not presented," " probably unauthorised user"  